...
````
#### 5.5 跨库join查询，customers表和orders使用的是不同的切分规则，两者做关联查询，使用的是代价较高的跨库join方式

````sql
mysql> select * from customers a,orders b where a.id=b.customer_id;
+----+---------+-----------+---------------+------------+----------+-------------+-------------------+-----------------------+
| ID | RAND_ID | NAME      | CUSTOMER_INFO | BIRTHDATE  | ORDER_ID | CUSTOMER_ID | ORDER_INFO        | CREATE_DATE           |
+----+---------+-----------+---------------+------------+----------+-------------+-------------------+-----------------------+
| 78 |      78 | 卢俊义    | 金牌会员      | 1987-05-01 |       65 |          78 | 卢俊义定单02      | 2016-07-27 00:00:00.0 |
| 78 |      78 | 卢俊义    | 金牌会员      | 1987-05-01 |       64 |          78 | 卢俊义定单01      | 2016-07-27 00:00:00.0 |
| 78 |      78 | 卢俊义    | 金牌会员      | 1987-05-01 |       66 |          78 | 卢俊义定单03      | 2016-07-27 00:00:00.0 |
| 81 |      81 | 关胜      | 铜牌会员      | 1932-03-01 |       69 |          81 | 关胜定单02        | 2016-07-27 00:00:00.0 |
| 81 |      81 | 关胜      | 铜牌会员      | 1932-03-01 |       70 |          81 | 关胜定单03        | 2016-07-27 00:00:00.0 |
| 81 |      81 | 关胜      | 铜牌会员      | 1932-03-01 |       68 |          81 | 关胜定单01        | 2016-07-27 00:00:00.0 |
| 79 |      79 | 吴用      | 银牌会员      | 1970-06-01 |       67 |          79 | 吴用定单01        | 2016-07-27 00:00:00.0 |
| 77 |      77 | 宋江      | 金牌会员      | 1985-01-01 |       61 |          77 | 宋江定单03        | 2016-07-27 00:00:00.0 |
| 77 |      77 | 宋江      | 金牌会员      | 1985-01-01 |       63 |          77 | 宋江定单05        | 2016-07-27 00:00:00.0 |
| 77 |      77 | 宋江      | 金牌会员      | 1985-01-01 |       59 |          77 | 宋江定单01        | 2016-07-27 00:00:00.0 |
| 77 |      77 | 宋江      | 金牌会员      | 1985-01-01 |       62 |          77 | 宋江定单04        | 2016-07-27 00:00:00.0 |
| 77 |      77 | 宋江      | 金牌会员      | 1985-01-01 |       60 |          77 | 宋江定单02        | 2016-07-27 00:00:00.0 |
+----+---------+-----------+---------------+------------+----------+-------------+-------------------+-----------------------+
12 rows in set (0.03 sec)
//
mysql> select CUSTOMER_ID, NAME,group_concat(ORDER_INFO), count(order_id)  from customers a,orders b where a.id=b.customer_id group by CUSTOMER_ID, NAME having count(order_id) > 1;
+-------------+-----------+----------------------------------------------------------------------------+-----------------+
| CUSTOMER_ID | NAME      | GROUP_CONCAT(ORDER_INFO)                                                   | COUNT(ORDER_ID) |
+-------------+-----------+----------------------------------------------------------------------------+-----------------+
|          77 | 宋江      | 宋江定单03,宋江定单05,宋江定单01,宋江定单04,宋江定单02                     |               5 |
|          81 | 关胜      | 关胜定单02,关胜定单03,关胜定单01                                           |               3 |
|          78 | 卢俊义    | 卢俊义定单02,卢俊义定单01,卢俊义定单03                                     |               3 |
+-------------+-----------+----------------------------------------------------------------------------+-----------------+
